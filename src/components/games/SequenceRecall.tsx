        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-8 flex-wrap">
            {sequence.map((item, i) => (
              <div
                key={i}
                className={`w-20 h-20 rounded-2xl flex items-center justify-center text-4xl transition-all duration-400 ease-[cubic-bezier(0.25,0.1,0.25,1)]
          ...
          <div className="grid grid-cols-4 md:grid-cols-6 gap-3">
            {shuffledItems.map((item, i) => (
              <button
                ...
                className="aspect-square rounded-2xl text-3xl flex items-center justify-center bg-white border-2 border-cream-200 hover:border-sage-300 hover:bg-sage-50 transition-all duration-400 ease-[cubic-bezier(0.25,0.1,0.25,1)] ease-[cubic-bezier(0.25,0.1,0.25,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage-400"
              >
                {item}
              </button>
            ))}
