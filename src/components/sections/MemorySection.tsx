      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div ref={cardsContainerRef} className="grid md:grid-cols-3 gap-8">
          {CARDS.map((item, i) => (
            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-white/60 backdrop-blur-xl border border-white/50 p-8 shadow-[0_4px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_40px_rgba(74,124,74,0.1)] hover:-translate-y-2 transition-all duration-500 h-full">
                {/* Glare */}
