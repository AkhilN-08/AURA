      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={metricsRef} className="space-y-4">
            {LEVELS.map((level, i) => (
              <div key={i} className="ai-metric relative overflow-hidden rounded-3xl bg-white/60 backdrop-blur-xl border border-white/50 p-5 shadow-[0_4px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_12px_40px_rgba(59,130,246,0.08)] transition-all duration-500" style={{ opacity: reducedMotion ? 1 : 0 }}>
