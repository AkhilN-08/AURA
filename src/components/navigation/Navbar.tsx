      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2.5 group" aria-label="AURA NER Home">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-forest-400/80 to-forest-600/80 backdrop-blur-sm border border-white/30 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-[0_0_16px_rgba(74,124,74,0.2)]">
              ...
              <Link
                ...
                className={`relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-400 ${
                  location.pathname === link.href
                    ? 'bg-forest-500/90 text-white shadow-[0_0_12px_rgba(74,124,74,0.3)]'
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/games"
              className="hidden md:inline-flex items-center gap-2 bg-gradient-to-r from-forest-500 to-forest-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold shadow-[0_0_20px_rgba(74,124,74,0.25)] hover:shadow-[0_0_30px_rgba(74,124,74,0.4)] hover:scale-105 transition-all duration-300"
            >
              Get Started
            </Link>
