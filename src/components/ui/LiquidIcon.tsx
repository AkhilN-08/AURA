...
export default function LiquidIcon({ children, className = '', size = 'md', color = 'forest' }: LiquidIconProps) {
  ...
  const colorMap: Record<string, string> = {
    forest: 'from-forest-400/40 to-forest-600/20 shadow-[0_0_20px_rgba(59,130,246,0.15)]',
    sage: 'from-sage-400/40 to-sage-600/20 shadow-[0_0_20px_rgba(96,165,250,0.15)]',
    amber: 'from-amber-300/40 to-amber-500/20 shadow-[0_0_20px_rgba(251,113,133,0.15)]',
